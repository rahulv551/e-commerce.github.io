    ...
    <footer className='footer p-5'>
      <div className="container-xxl">
        <div className="row">
          <div className="col-4 d-flex flex-column">
            ...
            <div className="footer-details">
              <p className='mb-3'><b>Address:</b>44/4, District Fund Road, Behind Big Bazaar,<br /> Jayanagara 9th Block, Bengaluru, Karnataka 560069</p>
              <p className='mb-3'><b>Phone:</b><a href="tel:+919900000001">Call us +919900000001</a></p>
              ...
              <div className="col-5 social-icons mb-3 d-flex justify-content-around">
                <Link><AiFillTwitterCircle className='fs-3' /></Link>
          ...
          <div className="col-4">
            ...
            <p>Available On Google Play Services & App Store</p>
              <div className='pay d-flex'>
                <Link className='mr-3'><img src={google} alt="" className='img-fluid p-4 my-3'/></Link>
                <Link><img src={app} alt="" className='img-fluid p-4 my-3'/></Link>
              </div>
              <p className="mb-3">Payment Methods</p>
              <Link className='pay'><img src={pay} alt="" className='img-fluid p-4 my-3'/></Link>
            </div>
          </div>
        </div>
        <hr />
        <div className="row d-flex justify-content-between">
          <div className="col-3">
            <p>&copy; Developed by group-11 Developers 2023</p>
          </div>
